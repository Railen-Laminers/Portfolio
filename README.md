Issues
- Make the maze runner playable in mobile
- Suzuka adventure game is not finished yet

Next Proj
- Create web apps (code racing)


Future
- Add some credits to the assets i used
MemaoCharacterFantasySpritePack-Galv For Characters
DeadlyEssence or Kailyn M. For Tilesets
